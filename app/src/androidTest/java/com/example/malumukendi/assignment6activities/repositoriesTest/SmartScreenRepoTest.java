...
import com.example.malumukendi.assignment6activities.repos.Impl.SmartScreenRepoImpl;
import com.example.malumukendi.assignment6activities.repos.SmartScreenRepo;
...
public class SmartScreenRepoTest extends AndroidTestCase {
    private static final String TAG="SMARTSCREEN TEST";
    private Long id;
